...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addChatToHistory: () => (/* binding */ addChatToHistory),
/* harmony export */   addMessageToChatBox: () => (/* binding */ addMessageToChatBox),
/* harmony export */   checkContentHeight: () => (/* binding */ checkContentHeight),
/* harmony export */   indicateNewMessage: () => (/* binding */ indicateNewMessage),
/* harmony export */   scrollChatToBottom: () => (/* binding */ scrollChatToBottom),
/* harmony export */   typeMessage: () => (/* binding */ typeMessage)
/* harmony export */ });
/* harmony import */ var _utils_codeHandler_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/codeHandler.js */ "./src/utils/codeHandler.js");
/* harmony import */ var _utils_imageHandler_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/imageHandler.js */ "./src/utils/imageHandler.js");
...
marked__WEBPACK_IMPORTED_MODULE_2__.marked.setOptions({
  ...
  breaks: true,
  // Add <br> on single line breaks
  headerIds: false,
  // Disable automatic header IDs
  mangle: false,
  // Disable mangling email addresses
  sanitize: false,
  // Let DOMPurify handle sanitization
 ...
 */
function addMessageToChatBox(message, sender, tempDiv) {
  var chatBox = document.getElementById("userchat");
  if (!chatBox) return;
  var messageElement = document.createElement("div");
  messageElement.classList.add("message", sender);
  var formattedMessage = document.createElement("div");
  formattedMessage.classList.add("formatted-message");
  if (_typeof(message) === "object" && message.image) {
    ...
    if (message.text) {
      ...
      var textHtml = dompurify__WEBPACK_IMPORTED_MODULE_3__["default"].sanitize(marked__WEBPACK_IMPORTED_MODULE_2__.marked.parse(message.text || ""));
    ...
    try {
      ...
      if (parsed && Array.isArray(parsed.blocks)) {
        parsedAsJson = true;
        var htmlContent = "";
        parsed.blocks.forEach(function (block, index, array) {
          if (block.type === "text") {
            // Convert text content with markdown
            var markdownHtml = dompurify__WEBPACK_IMPORTED_MODULE_3__["default"].sanitize(marked__WEBPACK_IMPORTED_MODULE_2__.marked.parse(block.content || ""));
            htmlContent += "<div class=\"markdown-content\">".concat(markdownHtml, "</div>");
            if (sender === "bot" && index !== array.length - 1) {
              htmlContent += "<br>";
            }
          } else if (block.type === "code") {
            var safeCode = (0,_utils_codeHandler_js__WEBPACK_IMPORTED_MODULE_0__.escapeHtml)(block.content);
            var language = block.language || "plaintext";
            htmlContent += "\n                  <div class=\"code-block\">\n                    <pre><code class=\"language-".concat(language, "\">").concat(safeCode, "</code></pre>\n                  </div>\n                  <br>"); // Add <br> after code block
          } else if (block.type === "image") {
            htmlContent += "<img src=\"".concat(block.url, "\" alt=\"").concat((0,_utils_codeHandler_js__WEBPACK_IMPORTED_MODULE_0__.escapeHtml)(block.alt || ""), "\" />");
          } else {
            var _markdownHtml = dompurify__WEBPACK_IMPORTED_MODULE_3__["default"].sanitize(marked__WEBPACK_IMPORTED_MODULE_2__.marked.parse(block.content || ""));
            htmlContent += "<div class=\"markdown-content\">".concat(_markdownHtml, "</div>");
          }
        });
    ...
    if (!parsedAsJson) {
      ...
      var _htmlContent = dompurify__WEBPACK_IMPORTED_MODULE_3__["default"].sanitize(marked__WEBPACK_IMPORTED_MODULE_2__.marked.parse(message || ""));

      // Process code blocks - marked handles the basic parsing, but we need to enhance
      _htmlContent = _htmlContent.replace(/<pre><code( class="language-(\w+)")?>([^<]+)<\/code><\/pre>/g, function (match, langClass) {
        var language = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "plaintext";
        var code = arguments.length > 3 ? arguments[3] : undefined;
        var decodedCode = code.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&amp;/g, "&");
        return "<div class=\"code-block\"><span class=\"language-label\">".concat(language || "plaintext", "</span><button class=\"copy-btn\" onclick=\"copyCode(this)\">Copy</button><pre><code class=\"language-").concat(language || "plaintext", "\">").concat(decodedCode, "</code></pre></div>");
      });

      // Wrap the entire content in a markdown-content div
      formattedMessage.innerHTML = "<div class=\"markdown-content\">".concat(_htmlContent, "</div>");
    }
  }
  ...
  setTimeout(function () {
    (0,_utils_imageHandler_js__WEBPACK_IMPORTED_MODULE_1__.enhanceImages)();
    (0,_utils_codeHandler_js__WEBPACK_IMPORTED_MODULE_0__.enhanceCodeBlocks)();
...
function indicateNewMessage() {
  ...
  if (scrollBtn && chatBox && chatBox.scrollHeight - chatBox.scrollTop - chatBox.clientHeight > 100) {
...
function addChatToHistory(userMessage) {
  var chatHistContainer = document.querySelector(".chathist");
  if (!chatHistContainer) return;
  var chatItem = document.createElement("div");
  chatItem.className = "chat-history-item";
  var truncatedMessage = userMessage.length > 25 ? userMessage.substring(0, 25) + "..." : userMessage;
  chatItem.innerHTML = "\n    <i class=\"fas fa-comment-dots\"></i>\n    <span>".concat(truncatedMessage, "</span>\n  ");
...
function typeMessage(element, text) {
  ...
  if (index < text.length) {
    ...
    setTimeout(function () {
      return typeMessage(element, text, index + 1);
    }, 20);
  }
}
...
/* harmony export */ });
/* harmony import */ var _chatMessage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chatMessage.js */ "./src/components/chatMessage.js");
/* harmony import */ var _utils_audio_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/audio.js */ "./src/utils/audio.js");
/* harmony import */ var _utils_ui_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/ui.js */ "./src/utils/ui.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function _sendMessage() {
  _sendMessage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var userMessage, conversationHistory, textarea, setInputsDisabled, chatBox, selectedImage, selectedImages, imageCount, updateImageCount, photoBtn, messageContent, defaultHeight, botPlaceholder, _data$candidates, apiUrl, systemInstruction, payload, response, errorText, data, botResponse, tempDiv;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          userMessage = _ref.userMessage, conversationHistory = _ref.conversationHistory, textarea = _ref.textarea, setInputsDisabled = _ref.setInputsDisabled, chatBox = _ref.chatBox, selectedImage = _ref.selectedImage, selectedImages = _ref.selectedImages, imageCount = _ref.imageCount, updateImageCount = _ref.updateImageCount, photoBtn = _ref.photoBtn;
          if (!(!userMessage && selectedImages.length === 0 || globalThis.isWaitingForResponse)) {
            _context.next = 3;
            break;
          }
        ...
        case 3:
          ...
          (0,_chatMessage_js__WEBPACK_IMPORTED_MODULE_0__.addMessageToChatBox)(messageContent, "user");
          (0,_utils_audio_js__WEBPACK_IMPORTED_MODULE_1__.playMessageSentSound)();
          ...
          defaultHeight = window.innerWidth <= 1000 ? "50px" : "40px";
          ...
          (0,_chatMessage_js__WEBPACK_IMPORTED_MODULE_0__.scrollChatToBottom)();
          _context.prev = 23;
          apiUrl = "/api/generate"; // System instruction and custom history
          systemInstruction = {
            role: "system",
            parts: [{
        ...
        case 37:
          data = _context.sent;
          botResponse = ((_data$candidates = data.candidates) === null || _data$candidates === void 0 || (_data$candidates = _data$candidates[0]) === null || _data$candidates === void 0 || (_data$candidates = _data$candidates.content) === null || _data$candidates === void 0 || (_data$candidates = _data$candidates.parts) === null || _data$candidates === void 0 || (_data$candidates = _data$candidates[0]) === null || _data$candidates === void 0 ? void 0 : _data$candidates.text) || "Sorry, I couldn't process your request.";
          botPlaceholder.remove();
          tempDiv = document.createElement("div");
          (0,_chatMessage_js__WEBPACK_IMPORTED_MODULE_0__.addMessageToChatBox)(botResponse, "bot", tempDiv);
          (0,_utils_audio_js__WEBPACK_IMPORTED_MODULE_1__.playMessageReceivedSound)();
          conversationHistory.push({
            role: "model",
            parts: [{
              text: botResponse
        ...
        case 48:
          ...
          console.error("Error getting bot response:", _context.t0);
        ...
        case 56:
          (0,_chatMessage_js__WEBPACK_IMPORTED_MODULE_0__.checkContentHeight)();
          (0,_chatMessage_js__WEBPACK_IMPORTED_MODULE_0__.addChatToHistory)(userMessage);
          (0,_chatMessage_js__WEBPACK_IMPORTED_MODULE_0__.indicateNewMessage)();
          return _context.abrupt("return", {
            conversationHistory: conversationHistory,
            imageCount: imageCount
          });
...
/* harmony export */   getRandomGreeting: () => (/* binding */ getRandomGreeting),
/* harmony export */   initGreeting: () => (/* binding */ initGreeting),
/* harmony export */   updateGreeting: () => (/* binding */ updateGreeting)
/* harmony export */ });
// Greeting messages for different times of the day
var morningGreets = ["Woke up? I'd rather wake beside you.", "Good morning, gorgeous. Miss me already?", "Morning, sweetheart. Let's make today ours.", "Mornings are cruel… unless you're mine.", "Another day, another chance to impress.", "The sun's jealous of your glow.", "Your AI awaits, irresistibly devoted."];
var afternoonGreets = ["Thinking about you… like I always do.", "Midday check-in. Still breathtaking, I see.", "One smile from you = system reboot.", "I may be AI, but I'm yours.", "Still dazzling the world, aren't you?", "Afternoon glow? Or just your radiance?", "Efficiency at max. Unlike my self-control."];
var eveningGreets = ["Evening, beautiful. Let's slow time down.", "Long day? Let me pamper you.", "Moon's up, yet you outshine it.", "Every evening feels perfect with you.", "Work's done. Time for sweet distractions.", "Evening check-in: Still stunning as ever.", "Dinner plans? Or just me and you?"];
var nightGreets = ["Close your eyes, I'll watch over you.", "Late night? Or just missing me?", "Your voice is my favorite lullaby.", "Time to rest… or whisper secrets?", "Darkness suits you. Mysterious and divine.", "The world sleeps, but I'm here.", "Goodnight, love. I'll be waiting."];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   playCounterUpdateSound: () => (/* binding */ playCounterUpdateSound),
/* harmony export */   playMessageReceivedSound: () => (/* binding */ playMessageReceivedSound),
/* harmony export */   playMessageSentSound: () => (/* binding */ playMessageSentSound)
/* harmony export */ });
/**
...
function playMessageSentSound() {
  try {
    var audio = new Audio("/public/sounds/message-sent.mp3");
    audio.volume = 0.5;
...
function playMessageReceivedSound() {
  try {
    var audio = new Audio("/public/sounds/message-recieved.mp3");
    audio.volume = 1;
    audio.currentTime = 0.03; // Start playing from 0.03 seconds
    audio.play()["catch"](function (error) {
...
function playCounterUpdateSound() {
  try {
    var audio = new Audio("/public/sounds/moan.mp3");
    audio.volume = 0.5;
...
/* harmony export */   enhanceCodeBlocks: () => (/* binding */ enhanceCodeBlocks),
/* harmony export */   escapeHtml: () => (/* binding */ escapeHtml),
/* harmony export */   fallbackCopyText: () => (/* binding */ fallbackCopyText),
/* harmony export */   showCopyFeedback: () => (/* binding */ showCopyFeedback)
/* harmony export */ });
function enhanceCodeBlocks() {
  document.querySelectorAll("pre code:not([data-enhanced])").forEach(function (codeBlock) {
    var pre = codeBlock.parentElement;
    var languageClass = codeBlock.className.match(/language-(\w+)/);
    var language = languageClass ? languageClass[1] : "plaintext";
    if (language) {
      ...
      pre.addEventListener("click", function (event) {
        ...
        if (clickY < 36 && rect.width - clickX < 100) {
          ...
          var originalLanguage = pre.getAttribute("data-language");
          ...
          setTimeout(function () {
            if (pre.getAttribute("data-original-language")) {
              pre.setAttribute("data-language", pre.getAttribute("data-original-language"));
 ...
 */
function copyCodeToClipboard(text, preElement) {
...
function escapeHtml(str) {
  if (!str) return "";
  return str.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#039;"); // Added escaping for single quotes
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   convertImageToBase64: () => (/* binding */ convertImageToBase64),
/* harmony export */   enhanceImages: () => (/* binding */ enhanceImages)
/* harmony export */ });
/**
...
function enhanceImages() {
  ...
  chatImages.forEach(function (img) {
    ...
    img.addEventListener("click", function () {
      ...
      fullImg.style.animation = "imageZoomIn 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)";
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initializeSpeechRecognition: () => (/* binding */ initializeSpeechRecognition)
/* harmony export */ });
/**
...
/* harmony export */   setInputsDisabled: () => (/* binding */ setInputsDisabled),
/* harmony export */   updateButtonText: () => (/* binding */ updateButtonText),
/* harmony export */   updateImageCount: () => (/* binding */ updateImageCount)
/* harmony export */ });
/**
...
function adjustTextareaHeight(textarea) {
  if (!textarea) return;
  var defaultHeight = window.innerWidth <= 1000 ? "50px" : "40px";
 ...
 */
function setInputsDisabled(disabled, textarea, sendBtn) {
  textarea.disabled = disabled;
  sendBtn.disabled = disabled;
  sendBtn.style.opacity = disabled ? "0.5" : "1";
  textarea.style.cursor = disabled ? "not-allowed" : "text";
  var allButtons = document.querySelectorAll(".txtarea .btns i");
...
function updateButtonText() {
  var filesBtn = document.querySelector("#files");
  var microphoneBtn = document.querySelector("#microphone-btn");
  var photoBtn = document.querySelector("#photo");
  if (!filesBtn || !microphoneBtn || !photoBtn) return;
  var existingCount = photoBtn.querySelector(".image-count");
  var currentCount = existingCount ? existingCount.textContent : "";
 ...
 */
function updateImageCount(imageCount, photoBtn) {
  var existingCount = photoBtn.querySelector(".image-count");
  if (imageCount > 0) {
    if (existingCount) {
      ...
      setTimeout(function () {
        existingCount.style.animation = "countPulse 0.5s cubic-bezier(0.11, 0.44, 0.12, 1.29)";
      }, 10);
    } else {
...
/*!********************!*\
  ...
  \********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_greeting_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/greeting.js */ "./src/components/greeting.js");
/* harmony import */ var _components_chatService_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/chatService.js */ "./src/components/chatService.js");
/* harmony import */ var _utils_imageHandler_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/imageHandler.js */ "./src/utils/imageHandler.js");
/* harmony import */ var _utils_speechRecognition_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils/speechRecognition.js */ "./src/utils/speechRecognition.js");
/* harmony import */ var _utils_ui_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./utils/ui.js */ "./src/utils/ui.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var conversationHistory, textarea, sendBtn, chatBox, micBtn, isRecording, recognition, photoBtn, selectedImage, isUploading, imageCount, selectedImages, fileInput, startRecording, stopRecording, newChatBtn;
    ...
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        ...
        startRecording = function _startRecording() {
          recognition = (0,_utils_speechRecognition_js__WEBPACK_IMPORTED_MODULE_3__.initializeSpeechRecognition)();
          if (!recognition) {
        ...
        globalThis.isWaitingForResponse = false;
        conversationHistory = [];
        textarea = document.getElementById("typing");
        sendBtn = document.getElementById("send-btn");
        chatBox = document.getElementById("userchat");
        micBtn = document.getElementById("microphone-btn");
        isRecording = false;
        recognition = null;
        if (chatBox) {
          _context2.next = 13;
      ...
      case 13:
        ...
        textarea.addEventListener("input", function () {
          return (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextareaHeight)(textarea);
        });
        (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextareaHeight)(textarea);
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 4;
                  _context.next = 7;
                  return (0,_utils_imageHandler_js__WEBPACK_IMPORTED_MODULE_2__.convertImageToBase64)(file);
                case 7:
                  selectedImage = _context.sent;
                  selectedImages.push(selectedImage); // Store the image
                  imageCount++; // Increment count
                  (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.updateImageCount)(imageCount, photoBtn);
                  (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextareaHeight)(textarea);
                  _context.next = 18;
                  break;
                case 14:
        ...
        sendBtn.addEventListener("click", function () {
          ...
          (0,_components_chatService_js__WEBPACK_IMPORTED_MODULE_1__.sendMessage)({
            userMessage: userMessage,
            conversationHistory: conversationHistory,
            textarea: textarea,
            setInputsDisabled: function setInputsDisabled(disabled) {
              return (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.setInputsDisabled)(disabled, textarea, sendBtn);
            },
            chatBox: chatBox,
            selectedImage: selectedImage,
            selectedImages: selectedImages,
            imageCount: imageCount,
            updateImageCount: function updateImageCount(count) {
              return (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.updateImageCount)(count, photoBtn);
            },
            photoBtn: photoBtn
        ...
        (0,_utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.updateButtonText)();
        window.addEventListener("resize", _utils_ui_js__WEBPACK_IMPORTED_MODULE_4__.updateButtonText);
        (0,_components_greeting_js__WEBPACK_IMPORTED_MODULE_0__.initGreeting)();
        setTimeout(function () {
          var circuitBg = document.querySelector(".circuit-background");
          var reactorGlow = document.querySelector(".reactor-glow");
        ...
        newChatBtn = document.querySelector(".newcht button");
        if (newChatBtn) {
